...
awk -v app_key="$app_key" \
    ...
    BEGIN {
      ...
      values["CDNF_DNSDIST_IMAGE"]="ghcr.io/vaheed/cdnfoundry-dnsdist:" release
      values["CDNF_PDNS_IMAGE"]="ghcr.io/vaheed/cdnfoundry-pdns:" release
      values["CDNF_PROMETHEUS_IMAGE"]="ghcr.io/vaheed/cdnfoundry-prometheus:" release
      values["CDNF_ALERTMANAGER_IMAGE"]="ghcr.io/vaheed/cdnfoundry-alertmanager:" release
      values["CDNF_NODE_EXPORTER_IMAGE"]="ghcr.io/vaheed/cdnfoundry-node-exporter:" release
      values["CDNF_VECTOR_IMAGE"]="ghcr.io/vaheed/cdnfoundry-vector:" release
