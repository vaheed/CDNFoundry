...
class GenerateOpenApi extends Command
{
    ...
    private function endpointMarkdown(array $catalog): string
    {
        $lines = [
            ...
            'registry, and CI fails if it differs from the implementation. See [API conventions](/reference/api/)',
        ...
        $lines[] = 'Download the machine-readable [OpenAPI 3.1 contract](/openapi.json).';
        $lines[] = '';
