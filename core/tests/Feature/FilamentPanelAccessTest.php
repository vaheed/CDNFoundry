...
class FilamentPanelAccessTest extends TestCase
{
    ...
    public function test_administrator_operational_pages_render_and_domain_users_cannot_open_them(): void
    {
        ...
        foreach (['/admin/users', '/admin/domains', '/admin/dns-clusters', '/admin/edges', '/admin/edge-pools', '/admin/operations', '/admin/audit-logs', '/admin/system-dns-identity', '/admin/tokens', '/admin/profile'] as $path) {
