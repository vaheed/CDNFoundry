...
use App\Http\Controllers\Admin\FleetRolloutController;
...
Route::middleware(['auth:sanctum', 'account.active', 'throttle:account'])->group(function (): void {
    ...
    Route::get('/domains/{domain}/security', [SecurityController::class, 'show']);
    Route::patch('/domains/{domain}/security', [SecurityController::class, 'update'])->middleware('idempotent');
    Route::get('/domains/{domain}/security/rules', [SecurityController::class, 'rules']);
    Route::post('/domains/{domain}/security/rules', [SecurityController::class, 'storeRule'])->middleware('idempotent');
    Route::patch('/domains/{domain}/security/rules/{rule}', [SecurityController::class, 'updateRule'])->middleware('idempotent');
    Route::delete('/domains/{domain}/security/rules/{rule}', [SecurityController::class, 'destroyRule'])->middleware('idempotent');
    Route::post('/domains/{domain}/security/rules/import', [SecurityController::class, 'importRules'])->middleware(['idempotent', 'throttle:bulk']);
    Route::get('/domains/{domain}/security/ddos', [SecurityController::class, 'ddos']);
    Route::patch('/domains/{domain}/security/ddos', [SecurityController::class, 'updateDdos'])->middleware('idempotent');
    ...
    Route::prefix('admin')->middleware('admin')->group(function (): void {
        ...
        Route::get('/fleet/releases', [FleetRolloutController::class, 'releases']);
        Route::post('/fleet/releases', [FleetRolloutController::class, 'storeRelease'])->middleware('idempotent');
        Route::get('/fleet/rollouts', [FleetRolloutController::class, 'index']);
        Route::post('/fleet/rollouts', [FleetRolloutController::class, 'store'])->middleware('idempotent');
        Route::get('/fleet/rollouts/{rollout}', [FleetRolloutController::class, 'show']);
        Route::post('/fleet/rollouts/{rollout}/resume', [FleetRolloutController::class, 'resume'])->middleware('idempotent');
        Route::post('/fleet/rollouts/{rollout}/rollback', [FleetRolloutController::class, 'rollback'])->middleware('idempotent');
        ...
        Route::post('/edge-pools/{pool}/edges/{edge}/endpoint', [EdgePoolController::class, 'storeEndpoint'])->middleware('idempotent');
        Route::patch('/edge-pools/{pool}/endpoints/{endpoint}', [EdgePoolController::class, 'updateEndpoint'])->middleware('idempotent');
        Route::delete('/edge-pools/{pool}/endpoints/{endpoint}', [EdgePoolController::class, 'destroyEndpoint'])->middleware('idempotent');
